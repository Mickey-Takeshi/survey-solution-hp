  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "外注から始める場合、初期投資はゼロで1案件20万〜80万円程度です。自社設備を導入する場合は3Dレーザースキャナで500万〜1,500万円、ドローン一式で200万〜500万円が目安ですが、IT導入補助金やものづくり補助金を活用すれば実質負担を1/4〜1/2に抑えられます。",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "まずは対象案件を一つ選び、外注で効果と運用課題を確認するのが現実的です。国土交通省は2024年4月にi-Construction 2.0を策定し、2040年度までに建設現場の省人化を少なくとも3割、生産性を1.5倍へ高める目標を示しています。",
      },
    },
  ],
};
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-white border border-gray-200 rounded-lg p-5">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  国土交通省は2024年4月にi-Construction 2.0を策定し、2040年度までに建設現場の省人化を少なくとも3割、生産性を1.5倍へ高める目標を示しました。発注図書にBIM/CIMやICT施工が含まれる案件では、従来のTS（トータルステーション）測量に加えて3次元データを扱う体制が必要です。
                </p>
              </div>
              <div className="bg-white border border-gray-200 rounded-lg p-5">
                <h3 className="text-lg font-bold text-gray-800 mb-2">2024年問題と人手不足の深刻化</h3>
                <p className="text-sm text-gray-700 leading-relaxed">
                  建設業の時間外労働上限規制の適用により、限られた人員・時間で成果を出す必要があります。国土交通省の資料では、建設業就業者の約36.7%が55歳以上で、今後10年間で大量退職が見込まれます。
                </p>
              </div>
              <div className="bg-white border border-gray-200 rounded-lg p-5">
            ...
            <div className="bg-primary/5 rounded-lg p-6 mb-8">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                補助金を活用すれば実質負担を1/4〜1/2に抑えられます。また、リース契約を利用すれば月額10万〜30万円で導入可能です。年間の3D測量案件が5件以上あれば、外注より自社保有が有利になるケースが多いです。
              </p>
            </div>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    { name: "中小企業新事業進出補助金", rate: "1/2（賃上げ特例2/3）", limit: "2,500万〜9,000万円", target: "新市場・高付加価値事業への進出（3D測量サービスの立ち上げ等）。事業再構築補助金の後継制度" },
              ...
              {[
                {
                  ...
                  a: "外注から始める場合、初期投資はゼロで1案件20万〜80万円程度です。自社設備を導入する場合は3Dレーザースキャナで500万〜1,500万円、ドローン一式で200万〜500万円が目安ですが、補助金を活用すれば実質負担を1/4〜1/2に抑えられます。",
                },
                {
                ...
                },
                {
                  ...
                  a: "対象案件を一つ選び、外注で効果と運用課題を確かめるところから始めるのが現実的です。国土交通省のi-Construction 2.0は2040年度までの省人化・生産性向上を掲げているため、自社案件で必要な3次元データの範囲を早めに把握しておくと移行しやすくなります。",
                },
              ].map((item) => (
            ...
            <div className="bg-gray-50 p-5 rounded-lg mb-6">
              ...
              <ul className="space-y-1.5 text-sm text-gray-700">
                ...
                <li>・ IT導入補助金やものづくり補助金を活用すれば、設備投資の実質負担を1/4〜1/2に軽減可能</li>
              </ul>
            </div>
            <p className="text-base leading-loose text-gray-700 mb-4">
