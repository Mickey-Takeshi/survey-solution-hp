...
export const metadata: Metadata = {
  ...
  description:
    "【2026年8月更新】ドローン測量（UAV測量）の費用相場を面積別の料金表で解説。1フライト（10ha以内）20万〜40万円が目安。費用の内訳、地上レーザーとの比較、安く抑える3つのコツまで土地家屋調査士が紹介します。",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "判断基準は明確です。広域（1ha以上）の地形測量や土量計算にはドローン、建物・構造物の高精度計測（±1〜3mm）や狭所計測には地上レーザーが向いています。両手法を組み合わせるハイブリッド計測という選択肢もあります。当社は地上レーザースキャンを担当し、現場条件に応じた最適な手法をご提案しています。",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "対応可能です。ただし国土交通省の要領に準拠した計測・データ処理と、出来形管理帳票までの一貫した対応が条件になります。なお当社が現在提供しているのは地上レーザースキャン・点群データ処理・3Dモデリングの3サービスで、ドローン計測は取り扱っておりません。",
      },
    },
  ],
};
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <time dateTime="2026-08-31" className="text-sm tracking-wider text-gray-500">（2026.08.31更新）</time>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { title: "定期測量は年間・複数回契約にする", desc: "出来形管理のように月1回・工程ごとの計測が必要なら、単発より年間契約が断然お得。フライトプラン・基準点の使い回しで初期コストも削減できます。" },
            ...
            <div className="space-y-4 mb-8">
              {[
                { q: "ドローン測量と地上レーザー、どちらを選べばよいですか？", a: "判断基準は明確です。広域（1ha以上）の地形測量や土量計算にはドローン、建物・構造物の高精度計測（±1〜3mm）や屋内計測には地上レーザー。両手法を組み合わせるハイブリッド計測という選択肢もあります。当社は地上レーザースキャンを担当し、現場条件を伺った上で最適な手法をご提案しています。" },
                ...
                { q: "ドローン測量はi-Construction（アイコンストラクション）に対応できますか？", a: "対応可能です。ただし国土交通省の要領に準拠した計測・データ処理と、出来形管理帳票までの一貫した対応が条件になります。なお当社が現在提供しているのは地上レーザースキャン・点群データ処理・3Dモデリングの3サービスで、ドローン計測は取り扱っておりません。" },
              ].map((item) => (
