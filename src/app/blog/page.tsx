...
const posts: {
  ...
  {
    slug: "building-3d-scan",
    date: "2026.07.23",
    dateTime: "2026-07-23",
    title: "建物の3D計測とは？費用相場・精度・建築現場での活用シーンを解説",
    description: "建物3D計測の手法別の精度、規模別の費用相場（15万円〜）、建築現場・建設現場での活用方法と成果物を解説します。",
    category: "基礎知識",
  ...
  },
  {
    ...
    description: "ドローン測量の費用相場を面積別の料金表で解説。費用の内訳、地上レーザーとの比較、費用を抑える3つのコツを紹介します。",
    category: "費用・相場",
  ...
  },
  {
    ...
    description: "3Dレーザースキャナーの基本原理（ToF方式・位相差方式）、4つの種類、購入・レンタル・外注の価格比較、主要メーカーを解説します。",
    category: "技術解説",
