...
const faqs = [
  {
    ...
    a: "使用する機器や条件にもよりますが、ミリメートル単位の高精度な計測が可能です。一般的な建物測量では±2〜5mm程度の精度を確保しています。対象物との距離や反射率によって精度は変動します。",
  },
  {
    q: "対応エリアはどこですか？",
  ...
  {
    q: "納期はどのくらいですか？",
    a: "案件の規模や内容によって異なりますが、小規模な建物や土地の測量であれば３～７日程度、大規模な施設や複雑な構造物、土地の場合は1〜2週間程度が目安です。お急ぎの場合は特急対応も可能ですので、ご相談ください。",
  },
  {
  ...
  },
  {
    ...
    a: "ご要望に応じて、CADデータ（DXF/DWG）、PDF図面、点群データ（LAS/E57）、3Dモデル（OBJ/FBX）など、様々な形式で納品可能です。",
  },
  {
